$(document).ready(function (e) {
    ...
    $(".xxk_title li").click(function () {
        ...
        $(".add_qusetion").children(".xxk_xzqh_box").eq(xxkjs).show().siblings().hide();

    });

//鼠标移上去显示按钮
    //对已有题目进行上移下移编辑等操作时的小框中的事件
    $(".movie_box").on(function () {
    ...
    //取消编辑
    $(".dx_box .qxbj_but").on("click", function () {
    ...
    //添加单选题目
    $(function () {
        $(".add_qusetion_danxuan_but").on("click", function () {
            var xuanxiang = $(".title_itram").children(".kzjxx_iteam").html();
            $(".yd_box").append("<div class=\"movie_box\">")
                .append("<ul class=\"wjdc_list\">")
                .append("<li>")
                .append("<div class=\"tm_btitlt\"><i class=\"nmb\">1</i>. <i class=\"btwenzi\">你有多久的公务员资历？</i></div>")
                .append("</li>")
                .append("<li>")
                .append("<label>")
                .append("  <input name=\"a\" type=\"radio\" value=\"\">")
                .append("  <span>0-3年</span></label>")
                .append("</li>")
                .append("<li>")
                .append("<label>")
                .append("  <input name=\"a\" type=\"radio\" value=\"\">")
                .append("   <span>4-10年</span></label>")
                .append("</li>")
                .append("<li>")
                .append("<label>")
                .append("  <input name=\"a\" type=\"radio\" value=\"\">")
                .append("  <span>11-20年</span></label>")
                .append("</li>")
                .append("<li>")
                .append("<label>")
                .append("  <input name=\"a\" type=\"radio\" value=\"\">")
                .append("  <span>20年以上</span></label>")
                .append("</li>")
                .append("<li>")
                .append("<label>")
                .append("  <input name=\"a\" type=\"radio\" value=\"\">")
                .append("  <span>其他</span> <input name=\"\" type=\"text\" class=\"wenb_input\"></label>")
                .append("</li>")
                .append("      </ul>")
                .append("      <div class=\"dx_box\" data-t=\"0\"></div>")
                .append("    </div>")
    ...
    //取消添加单选题目
    $(function () {
        $(".cancel_add_danxuan_but").on("click", function () {
            $(this).parent(".bjqxwc_box").parent(".dx_box").empty().hide();
            $(".movie_box").css({"border": "1px solid #fff"});
            $(".kzqy_czbut").remove();
            //
    ...
    //添加多选题目
    $(function () {
        $(".add_qusetion_duoxuan_but").on("click", function () {
            var jcxxxx = $(this).parent(".bjqxwc_box").parent(".dx_box");
            //编辑题目选项的个数
            var bjtm_xm_length = jcxxxx.find(".title_itram").children(".kzjxx_iteam").length;
            var xmtit_length = jcxxxx.parent(".movie_box").children(".wjdc_list").children("li").length - 1;
    ...
    //取消添加多选题目
    $(function () {
        $(".cancel_add_duoxuan_but").on("click", function () {
            $(this).parent(".bjqxwc_box").parent(".dx_box").empty().hide();
            $(".movie_box").css({"border": "1px solid #fff"});
            $(".kzqy_czbut").remove();
            //
